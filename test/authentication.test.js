...
describe('oauth2 app', () => {
  ...
  it('generates an authorize URL', async () => {
    ...
    expect(authorizeUrl).toBe(
      `https://github.com/login/oauth/authorize?client_id=${process.env.CLIENT_ID}&state=4444&redirect_uri=https%3A%2F%2Fzapier.com%2F&response_type=code&scope=repo%20gist%20user`
    );
  });
});
